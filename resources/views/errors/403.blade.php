...
<head>
    ...
    <title>403 Forbidden - CE&P Internal Audit System</title>
...
<body class="min-h-full bg-[#F4F7FB] text-slate-800 antialiased">
    <main class="min-h-screen flex items-center justify-center px-6 py-12 relative overflow-hidden">
        ...
        <section class="relative w-full max-w-xl bg-white border border-slate-100 rounded-3xl premium-shadow p-8 sm:p-12 text-center">
            <div class="mx-auto mb-6 h-16 w-16 rounded-2xl bg-rose-50 text-rose-600 flex items-center justify-center border border-rose-100">
                <i class="ph ph-lock-key text-3xl"></i>
            </div>

            <p class="text-sm font-extrabold text-rose-600 tracking-[0.18em] uppercase mb-3">403 Forbidden</p>
            <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-900 mb-4">Access denied</h1>
            <p class="text-slate-500 font-medium leading-relaxed mb-8">
                You do not have permission to open this page or resource.
            </p>
